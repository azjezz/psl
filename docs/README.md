...
- [map](./../src/Psl/Arr/map.php) ( deprecated )
...
- [partition](./../src/Psl/Dict/partition.php)
...
- [reduce](./../src/Psl/Iter/reduce.php)
...
- [float](./../src/Psl/PseudoRandom/float.php)
...
- [is_iterable](./../src/Psl/Type/is_iterable.php) ( deprecated )
