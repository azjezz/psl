...
Html\encode('&amp; is an ampersand', double_encoding: false);
...
See [src/Psl/Html/](https://github.com/php-standard-library/php-standard-library/tree/5.5.0/src/Psl/Html/) for the full API.
