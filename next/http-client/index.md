...
See [src/Psl/HTTP/Client/](https://github.com/php-standard-library/php-standard-library/tree/next/packages/http-message/src/Psl/HTTP/Client/) for the full API.
