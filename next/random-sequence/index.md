...
See [src/Psl/RandomSequence/](https://github.com/php-standard-library/php-standard-library/tree/next/packages/random-sequence/src/Psl/RandomSequence/) for the full API.
