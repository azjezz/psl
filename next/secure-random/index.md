...
See [src/Psl/SecureRandom/](https://github.com/php-standard-library/php-standard-library/tree/next/packages/secure-random/src/Psl/SecureRandom/) for the full API.
