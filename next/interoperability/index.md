...
See [src/Psl/Interoperability/](https://github.com/php-standard-library/php-standard-library/tree/next/packages/interoperability/src/Psl/Interoperability/) for the full API.
