...
See [src/Psl/DataStructure/](https://github.com/php-standard-library/php-standard-library/tree/next/packages/data-structure/src/Psl/DataStructure/) for the full API.
