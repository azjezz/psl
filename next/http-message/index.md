...
See [src/Psl/HTTP/Message/](https://github.com/php-standard-library/php-standard-library/tree/next/packages/http-message/src/Psl/HTTP/Message/) for the full API.
