...
See [src/Psl/Compression/](https://github.com/php-standard-library/php-standard-library/tree/next/packages/compression/src/Psl/Compression/) for the full API.
