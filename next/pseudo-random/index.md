...
See [src/Psl/PseudoRandom/](https://github.com/php-standard-library/php-standard-library/tree/next/packages/pseudo-random/src/Psl/PseudoRandom/) for the full API.
