...
final class RangeTest extends TestCase
{
    ...
    {
        static::assertSame([1], Vec\values::<int>(Vec\range::<int>(1, 1, 1)));
        static::assertSame([0, 1, 2, 3, 4, 5], Vec\values::<int>(Vec\range::<int>(0, 5)));
        static::assertSame([5, 4, 3, 2, 1, 0], Vec\values::<int>(Vec\range::<int>(5, 0)));
        static::assertSame([0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0], Vec\values::<float>(Vec\range::<float>(0.0, 3.0, 0.5)));
        static::assertSame([3.0, 2.5, 2.0, 1.5, 1.0, 0.5, 0.0], Vec\values::<float>(Vec\range::<float>(3.0, 0.0, -0.5)));
    }
    ...
    public function testRangeWithLargeIntsBeyondFloatPrecision(): void
    {
        ...
        $result = Vec\range::<int>($start, $end);
