...
final class SearchTest extends TestCase
{
    ...
    {
        static::assertSame($expected, Iter\search::<string>($iterable, $predicate));
    }
    ...
    public static function provideData(): iterable
    {
        ...
        yield [null, Iter\to_iterator::<int, string>(['foo', 'bar', 'baz']), static fn(string $v): bool => 'qux' === $v];
        yield [null, Iter\to_iterator::<int, string>([]), static fn(string $v): bool => 'qux' === $v];
    }
}
