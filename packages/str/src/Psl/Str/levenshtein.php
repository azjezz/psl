...
function levenshtein(
    string $source,
    string $target,
    null|int $costOfInsertion = null,
    null|int $costOfReplacement = null,
    null|int $costOfDeletion = null,
): int {
    if (null === $costOfDeletion && null === $costOfInsertion && null === $costOfReplacement) {
    ...
    Psl\invariant(
        null !== $costOfDeletion && null !== $costOfInsertion && null !== $costOfReplacement,
        'Expected either all costs to be supplied, or non.',
    );

    return php_levenshtien($source, $target, $costOfInsertion, $costOfReplacement, $costOfDeletion);
}
