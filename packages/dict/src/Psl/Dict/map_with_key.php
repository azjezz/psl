 ...
 *
 * @return ($iterable is non-empty-array|non-empty-list ? non-empty-array<Tk, T> : array<Tk, T>)
 *
 * @api
 */
function map_with_key<Tk : int|string = int|string, Tv = mixed, T = mixed>(iterable $iterable, Closure $function): array
{
    $result = [];
