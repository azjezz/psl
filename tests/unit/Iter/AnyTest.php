...
final class AnyTest extends TestCase
{
    ...
    public static function provideData(): iterable
    {
        ...
        yield [true, [false, false, false], static fn(bool $_): bool => true];
        yield [false, [false, false, false], static fn(bool $_): bool => false];
        ...
        yield [false, [], static fn(bool $_): bool => false];
    }
}
