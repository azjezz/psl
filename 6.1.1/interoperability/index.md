...
See [src/Psl/Interoperability/](https://github.com/php-standard-library/php-standard-library/tree/6.1.1/packages/interoperability/src/Psl/Interoperability/) for the full API.
