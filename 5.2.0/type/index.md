...
$integer = Type\int();
$strict_integer = Type\always_assert(Type\int());

$integer->coerce('1'); // 1 (coerced from string)

try {
    $strict_integer->coerce('1'); // CoercionException!
...
See [src/Psl/Type/](https://github.com/php-standard-library/php-standard-library/tree/5.2.0/src/Psl/Type/) for the full API.
