...
See [src/Psl/RandomSequence/](https://github.com/php-standard-library/php-standard-library/tree/6.1.2/packages/random-sequence/src/Psl/RandomSequence/) for the full API.
