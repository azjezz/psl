    ...
    MutableIndexAccessInterface
{
     ...
     *
     * @return MutableAccessibleCollectionInterface<Tk, Tv> - a Collection containing the values after
     ...
     *
     * @param $n - The last element that will be included in the returned `MutableAccessibleCollectionInterface`.
     *
