...
/**
 * {@see ConnectOptions} encapsulates all configurable options for establishing a TLS connection.
 *
 ...
 *
 * Instances of {@see ConnectOptions} should be created using the static `create()` method, which provides a starting
 ...
 * ```
 *
 * @immutable The class is designed to be immutable, ensuring that an instance once created cannot be modified.
 */
final class ConnectOptions implements DefaultInterface
{
     ...
     *
     * @return ConnectOptions The new instance with default values.
     *
     * @pure
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified minimum TLS version.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified peer name.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with peer verification enabled.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified verification depth.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the added peer fingerprint.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified peer fingerprints.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance without any peer fingerprints.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified ciphers.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified CA file path.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified CA directory path.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified peer certificate capturing setting.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified SNI setting.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified security level.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified certificate.
     *
     * @mutation-free
     */
     ...
     *
     * @return ConnectOptions A new instance with the specified ALPN protocols.
     *
     * @mutation-free
     */
