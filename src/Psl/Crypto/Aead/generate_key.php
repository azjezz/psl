...
{
    $raw = match ($algorithm) {
        Algorithm::Aes256Gcm => Internal\call_sodium(fn() => sodium_crypto_aead_aes256gcm_keygen()),
        Algorithm::XChaCha20Poly1305 => Internal\call_sodium(
            fn() => sodium_crypto_aead_xchacha20poly1305_ietf_keygen(),
        ),
        Algorithm::ChaCha20Poly1305 => Internal\call_sodium(fn() => sodium_crypto_aead_chacha20poly1305_ietf_keygen()),
    };
