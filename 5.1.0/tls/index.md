...
$config = TLS\ClientConfig::default()->withAlpnProtocols(['h2', 'http/1.1'])->withMinimumVersion(TLS\Version::Tls12);
...
See [src/Psl/TLS/](https://github.com/php-standard-library/php-standard-library/tree/5.1.0/src/Psl/TLS/) for the full API.
